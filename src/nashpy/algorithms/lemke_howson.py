...
#+===========
	...
	print('col_tableau: \n', col_tableau)
	print('non_basic_variables(row_tableau) - zero_basic_variables(row_tableau):', non_basic_variables(row_tableau) - zero_basic_variables(row_tableau))
	print('range(A.shape[0], sum(A.shape)): ', range(A.shape[0], sum(A.shape)))
